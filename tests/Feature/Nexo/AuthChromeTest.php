...
// verification.notice needs a signed-in user, so it answers with a redirect and
// authPages() leaves it out. There is no confirm-password screen here.
const AUTH_ROUTES = ['login', 'register', 'password.request', 'verification.notice'];
// THE documented exception of the ecosystem (STANDARD.md "Auth y errores"):
// this is the identity provider, so its sign-in and consent flow drops the
// header and the app-switcher on purpose — nothing should invite you to leave
// mid-flow. The theme and language controls stay, and this guardian is what
// keeps that trade honest.
const FOCUSED_AUTH = true;
