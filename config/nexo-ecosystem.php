...
// footer's ecosystem links. `current` marks this tool (nexoid). URLs are
...
return [
    ...
    // identity. This repo is nexoid, so it defaults to 'nexoid'.
    'current' => env('NEXO_ECOSYSTEM_CURRENT', 'nexoid'),
